...
2) You can use ``nnogada`` in Google Colab, please see the Section `Using Google Colab in Requirements <requirements.html#using-google-colab>`_.

3) On the other hand, you can visit the `GitHub code repository <https://github.com/igomezv/Nnogada.git>`_, download the `source code here <https://github.com/igomezv/Nnogada/archive/refs/heads/master.zip>`_ or clone it as follows:
